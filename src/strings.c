...
const u8 gText_BurnMenu[] = _("Burn");
const u8 gText_FrostbiteMenu[] = _("Frostbite");
const u8 gText_ParalyzeMenu[] = _("Paralyze");
const u8 gText_PoisonMenu[] = _("Poison");
const u8 gText_ToxicMenu[] = _("Toxic");
const u8 gText_SleepMenu[] = _("Sleep");
