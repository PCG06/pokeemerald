static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 6, 21},
    ...
    [HEAL_LOCATION_MT_CHIMNEY - 1] = {MAP_GROUP(ROUTE112), MAP_NUM(ROUTE112), 11, 37},
    [HEAL_LOCATION_WEATHER_INST - 1] = {MAP_GROUP(ROUTE119), MAP_NUM(ROUTE119), 6, 33},
    [HEAL_LOCATION_ROUTE_121 - 1] = {MAP_GROUP(ROUTE121), MAP_NUM(ROUTE121), 2, 7},
    [HEAL_LOCATION_ROUTE_128 - 1] = {MAP_GROUP(ROUTE128), MAP_NUM(ROUTE128), 42, 18},
    [HEAL_LOCATION_SPEAR_PILLAR - 1] = {MAP_GROUP(SPEAR_PILLAR), MAP_NUM(SPEAR_PILLAR), 48, 2},
};
