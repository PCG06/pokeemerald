...
{
    [MENUITEM_TEXTSPEED]   = gText_InstantText,
...
// remove these after upstream merge
static u8 const gText_TextSpeedSlow[] = _("");
static u8 const gText_TextSpeedMid[] = _("");
static u8 const gText_TextSpeedFast[] = _("");
