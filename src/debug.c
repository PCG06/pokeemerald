...
enum FlagsVarsDebugMenu
{
    ...
    DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_SCALEMONS,
};
...
static void DebugAction_FlagsVars_ScalemonsOnOff(u8 taskId);
...
static const struct DebugMenuOption sDebugMenu_Actions_Flags[] =
{
    ...
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_SCALEMONS]     = { COMPOUND_STRING("Toggle {STR_VAR_1}Scalemons OFF"),   DebugAction_ToggleFlag, DebugAction_FlagsVars_ScalemonsOnOff },
    { NULL }
};
...
static u32 Debug_CheckToggleFlags(u8 id)
{
    ...
    case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_SCALEMONS:
        result = P_FLAG_SCALEMONS ? FlagGet(P_FLAG_SCALEMONS) : DEBUG_OPTION_CANT_BE_TOGGLED;
        break;
