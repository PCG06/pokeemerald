...
static void GetTrainerIdFromLocalId(u32 localId)
{
    ...
    if (gSaveBlock2Ptr->optionsBattlesType == OPTIONS_BATTLE_TYPE_DOUBLES
     || GetTrainerBattleType(sDebugMenuListData->data[0]) == TRAINER_BATTLE_TYPE_DOUBLES)
...
static void DebugAction_Trainers_TryBattle(u8 taskId)
{
    ...
    if (gSaveBlock2Ptr->optionsBattlesType == OPTIONS_BATTLE_TYPE_DOUBLES 
     || sDebugMenuListData->data[5] || partnerId != PARTNER_NONE || trainer2Id != TRAINER_NONE)
...
static void DebugAction_Party_BattleSingle(u8 taskId)
{
    ...
    gBattleTypeFlags = BATTLE_TYPE_TRAINER;
    if (gSaveBlock2Ptr->optionsBattlesType == OPTIONS_BATTLE_TYPE_DOUBLES
     || sDebugTrainers[DIFFICULTY_NORMAL][DEBUG_TRAINER_AI].battleType == TRAINER_BATTLE_TYPE_DOUBLES)
        gBattleTypeFlags |= BATTLE_TYPE_DOUBLE;
