...
const u8 gText_BattleMenuNoBag[] = _("{PALETTE 5}{BACKGROUND DYNAMIC_COLOR5}{TEXT_COLORS DYNAMIC_COLOR4 DYNAMIC_COLOR6 DYNAMIC_COLOR5}Fight{CLEAR_TO 56}{COLOR TRANSPARENT}Bag\n{TEXT_COLORS DYNAMIC_COLOR4 DYNAMIC_COLOR6 DYNAMIC_COLOR5}Pokémon{CLEAR_TO 56}Run");
