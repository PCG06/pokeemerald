...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_FLOAROMA_TOWN] = MAPPOPUP_THEME_WOOD, 
    [MAPSEC_ETERNA_CITY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_HEARTHOME_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SOLACEON_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CELESTIC_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_VEILSTONE_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_PASTORIA_CITY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_CANALAVE_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SNOWPOINT_CITY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_SUNYSHORE_CITY] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_ROUTE_218] = MAPPOPUP_THEME_UNDERWATER, 
    [MAPSEC_ROUTE_219] = MAPPOPUP_THEME_WOOD, 
    [MAPSEC_ROUTE_220] = MAPPOPUP_THEME_UNDERWATER, 
    [MAPSEC_ROUTE_221] = MAPPOPUP_THEME_WOOD, 
    [MAPSEC_ROUTE_222] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_223] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_224] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_225] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_226] = MAPPOPUP_THEME_WOOD, 
    [MAPSEC_ROUTE_227] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_228] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_229] = MAPPOPUP_THEME_WOOD, 
    [MAPSEC_ROUTE_230] = MAPPOPUP_THEME_UNDERWATER, 
    [MAPSEC_FIGHT_AREA] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SURVIVAL_AREA] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_RESORT_AREA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LAKE_VERITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LAKE_VALOR] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LAKE_ACUITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_OREBURGH_GATE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_OREBURGH_MINE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_RAVAGED_PATH] = MAPPOPUP_THEME_STONE,
    [MAPSEC_FLOAROMA_MEADOW] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_OLD_CHATEAU] = MAPPOPUP_THEME_STONE,
    [MAPSEC_WAYWARD_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MT_CORONET] = MAPPOPUP_THEME_STONE,
    ...
    [MAPSEC_ACUITY_LAKEFRONT] = MAPPOPUP_THEME_WOOD,
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_OREBURGH_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FLOAROMA_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ETERNA_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_HEARTHOME_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SOLACEON_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CELESTIC_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_VEILSTONE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PASTORIA_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CANALAVE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SNOWPOINT_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SUNYSHORE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_201] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_202] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_203] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_204] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_205] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_206] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_207] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_208] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_209] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_210] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_211] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_212] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_213] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_214] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_215] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_216] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_217] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_218] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_219] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_220] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_221] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_222] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_223] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_224] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_225] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_226] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_227] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_228] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_229] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_230] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FIGHT_AREA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SURVIVAL_AREA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_RESORT_AREA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LAKE_VERITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LAKE_VALOR] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LAKE_ACUITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_OREBURGH_GATE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_OREBURGH_MINE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_RAVAGED_PATH] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FLOAROMA_MEADOW] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_VALLEY_WINDWORKS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FUEGO_IRONWORKS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ETERNA_FOREST] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_OLD_CHATEAU] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_WAYWARD_CAVE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MT_CORONET] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_VERITY_LAKEFRONT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_VALOR_LAKEFRONT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ACUITY_LAKEFRONT] = MAPPOPUP_THEME_BW_DEFAULT,
};
