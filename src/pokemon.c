...
// Using GetSpeciesBaseStatTotal() would cause indirect recursion with no exit
u32 GetSpeciesBaseStatTotalForScaling(enum Species species)
{
...
u32 GetSpeciesScaledBaseStat(enum Species species, u8 stat)
{
    u8 baseHP = gSpeciesInfo[species].baseHP;
    u16 bst = GetSpeciesBaseStatTotalForScaling(species);
...
{
    species = SanitizeSpeciesId(species);
    return GetSpeciesScaledBaseStat(species, gSpeciesInfo[species].baseAttack);
}

u32 GetSpeciesBaseDefense(enum Species species)
{
    return GetSpeciesScaledBaseStat(species, gSpeciesInfo[species].baseDefense);
}

u32 GetSpeciesBaseSpAttack(enum Species species)
{
    return GetSpeciesScaledBaseStat(species, gSpeciesInfo[species].baseSpAttack);
}

u32 GetSpeciesBaseSpDefense(enum Species species)
{
    return GetSpeciesScaledBaseStat(species, gSpeciesInfo[species].baseSpDefense);
}

u32 GetSpeciesBaseSpeed(enum Species species)
{
    return GetSpeciesScaledBaseStat(species, gSpeciesInfo[species].baseSpeed);
}
