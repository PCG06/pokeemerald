...
AI_SINGLE_BATTLE_TEST("sheer force moveeffectinplus")
{
    GIVEN {
        ...
        OPPONENT(SPECIES_GRIMMSNARL_MEGA){ Level(85); Nature(NATURE_QUIET); Ability(ABILITY_SHEER_FORCE); Item(ITEM_GRIMMITE); Speed(96); Moves(MOVE_MOONBLAST, MOVE_AURA_SPHERE); }
    } WHEN {
        TURN { 
